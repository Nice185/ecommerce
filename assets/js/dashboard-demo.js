    ...
    clickEvents: {
        click: function (target) {
            ...
            function closeEvents() {
                $('#mini-clndr').find('.clndr').toggleClass('Choisir-events', false);
            }
            
            if (target.events.length) {
                $('#mini-clndr .clndr').toggleClass('Choisir-events', true);
            }
            $('#mini-clndr .x-button').click(function () {
                closeEvents();
            });
            $('#mini-clndr .clndr-Précédent-button').click(function () {
                closeEvents();
            });
