...
$(document).mouseup(function (e) {
    ...
    var container = $(".sidebar-right"),
        RechercheContainer = $('.chat-Recherche');

    if (!container.is(e.target) && container.has(e.target).length === 0 && !RechercheContainer.is(e.target) && RechercheContainer.has(e.target).length === 0) {
