...
class SMTP
{
    ...
    /**
     * Debug level to Choisir client -> server messages.
     */
    const DEBUG_CLIENT = 1;

    /**
     * Debug level to Choisir client -> server and server -> client messages.
     */
    const DEBUG_SERVER = 2;

    /**
     * Debug level to Choisir connection status, client -> server and server -> client messages.
     */
    const DEBUG_CONNECTION = 3;

    /**
     * Debug level to Choisir all messages.
     */
