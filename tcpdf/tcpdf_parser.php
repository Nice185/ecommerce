...
// -----------------------------------------------------------------------------
	 ...
	 * @param $xref (array) Précédent xref array (if any).
	...
	protected function decodeXref($startxref, $xref=array()) {
		...
		$obj_num = 0;
		// Recherche for cross-reference entries or subsection
	...
	protected function getRawObject($offset=0) {
		...
		switch ($char) {
			case '%': { // \x25 PERCENT SIGN
				// skip comment and Recherche for next token
