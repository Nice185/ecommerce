              ...
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    ...
                    try{
                      $stmt = $conn->prepare("SELECT *, cart.id AS cartid FROM cart LEFT JOIN article ON article.codeArt=cart.codeArt WHERE user_id=:user_id");
                      ...
                      foreach($stmt as $row){
                        echo "
                          <tr>
                            ...
                            <td>".$row['quantity']."</td>
                            <td>
                              <button class='btn btn-success btn-sm edit btn-flat' data-id='".$row['cartid']."'><i class='fa fa-edit'></i> Editer Quantité</button>
...
function getRow(id){
  $.ajax({
    ...
    success: function(response){
      ...
      $('.productname').html(response.libelArt);
