<?php
	...
	function generateRow($from, $to, $conn){
		...
		$total = 0;
		foreach($stmt as $row){
			$stmt = $conn->prepare("SELECT * FROM details LEFT JOIN article ON article.codeArt=details.codeArt WHERE sales_id=:id");
	...
	if(isset($_POST['print'])){
	    ...
	    $content = '';  
	    $content .= '
	      	<h2 align="center">Solutions Informatiques TechSoft </h2>
	      	<h4 align="center">RAPPORT DE VENTES</h4>
	      	<h4 align="center">'.$from_title." - ".$to_title.'</h4>
	      	<table border="1" cellspacing="0" cellpadding="3">  
	           <tr>  
	           		<th width="15%" align="center"><b>Date</b></th>
	                <th width="30%" align="center"><b>Nom du client</b></th>
		...
		$_SESSION['error'] = 'Besoin d\'une plage de dates pour fournir une impression de vente';
