<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li><a href="sales.php"><i class="fa fa-money"></i> <span>Transactions</span></a></li>
      <li class="treeview">
        <a href="#">
        ...
        <ul class="treeview-menu">
          <li><a href="products.php"><i class="fa fa-circle-o"></i> Liste des articles</a></li>
          <li><a href="category.php"><i class="fa fa-circle-o"></i> Categories</a></li>
        </ul>
      </li>
      <li class="header">GESTION DU CLIENT</li>
