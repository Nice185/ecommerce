                ...
                <tbody>
                  <?php
                    ...
                    try{
                      ...
                      $stmt->execute();
                      foreach($stmt as $row){
                        $stmt = $conn->prepare("SELECT * FROM details LEFT JOIN article ON article.codeArt=details.codeArt WHERE details.sales_id=:id");
                        ...
                        echo "
                          <tr>
                            ...
                            <td><button type='button' class='btn btn-info btn-sm btn-flat transact' data-id='".$row['salesid']."'><i class='fa fa-Recherche'></i> Vu</button></td>
                          </tr>
                        ";
                      }
                    }
