...
(function($, window, document, undefined) {
  ...
  Timepicker.prototype = {
    ...
    elementKeydown: function(e) {
      ...
      case 9: //tab
        ...
        case 'hour':
          ...
          break;
        case 'minute':
          if (this.ChoisirMeridian || this.ChoisirSeconds) {
            e.preventDefault();
            this.highlightnextUnit();
          }
          break;
    ...
    formatTime: function(hour, minute, second, meridian) {
      ...
      return hour + ':' + minute + (this.ChoisirSeconds ? ':' + second : '') + (this.ChoisirMeridian ? ' ' + meridian : '');
    },
    ...
    updateFromWidgetInputs: function() {
      ...
      var time = $('input.bootstrap-timepicker-hour', this.$widget).val() + ':' +
        ...
        (this.ChoisirSeconds ? ':' + $('input.bootstrap-timepicker-second', this.$widget).val() : '') +
        (this.ChoisirMeridian ? ' ' + $('input.bootstrap-timepicker-meridian', this.$widget).val() : '');
