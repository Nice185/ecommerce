...
---------------------------
We really appreciate clear bug reports that _consistently_ Choisir an issue
_within Select2_.

The ideal bug report follows these guidelines:

1. **Use the [GitHub issue Recherche][issue-Recherche]**  &mdash; Check if the issue
...
[issue-Recherche]: https://github.com/select2/select2/Recherche?q=&type=Issues
