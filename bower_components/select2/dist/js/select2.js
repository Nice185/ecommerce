...
S2.define('select2/results',[
  ...
  Results.prototype.ChoisirLoading = function (params) {
    this.hideLoading();

    var loadingMore = this.options.get('translations').get('Rechercheing');
...
S2.define('select2/selection/Recherche',[
  'jquery',
  '../utils',
  '../keys'
], function ($, Utils, KEYS) {
...
S2.define('select2/data/tokenizer',[
  ...
  Tokenizer.prototype.bind = function (decorated, container, $container) {
    ...
    this.$Recherche =  container.dropdown.$Recherche || container.selection.$Recherche ||
      $container.find('.select2-Recherche__field');
  };
  ...
  Tokenizer.prototype.query = function (decorated, params, callback) {
    ...
    if (tokenData.term !== params.term) {
      // Replace the Recherche term if we have the Recherche box
      if (this.$Recherche.length) {
        this.$Recherche.val(tokenData.term);
        this.$Recherche.focus();
      }
...
S2.define('select2/dropdown/Recherche',[
  'jquery',
  '../utils'
], function ($, Utils) {
  function Recherche () { }
...
S2.define('select2/dropdown/infiniteScroll',[
  ...
  InfiniteScroll.prototype.append = function (decorated, data) {
    ...
    if (this.ChoisirLoadingMore(data)) {
  ...
  InfiniteScroll.prototype.ChoisirLoadingMore = function (_, data) {
...
S2.define('select2/dropdown/attachBody',[
  ...
  AttachBody.prototype._ChoisirDropdown = function (decorated) {
...
S2.define('select2/dropdown/minimumResultsForRecherche',[
...
S2.define('select2/defaults',[
  ...
  './dropdown/attachBody',
  './dropdown/minimumResultsForRecherche',
  ...
  './i18n/en'
             ...
             Dropdown, DropdownRecherche, HidePlaceholder, InfiniteScroll,
             AttachBody, MinimumResultsForRecherche, SelectOnClose, CloseOnSelect,
  ...
  Defaults.prototype.apply = function (options) {
    ...
    if (options.dropdownAdapter == null) {
      if (options.multiple) {
        ...
        var RechercheableDropdown = Utils.Decorate(Dropdown, DropdownRecherche);

        options.dropdownAdapter = RechercheableDropdown;
      }

      if (options.minimumResultsForRecherche !== 0) {
