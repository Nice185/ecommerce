...
- Add `Rechercheing` and `errorLoading` Finnish translations [https://github.com/select2/select2/pull/4730]
...
- Apply `ajax.delay` to empty Recherche terms as well [https://github.com/select2/select2/commit/4b9e02f02211248be25ac4c16d4635cf38237bb9]
...
- Corrected responsive width example to properly Choisir it working [https://github.com/select2/select2/commit/63d531a9c0ab51f05327492a56f3245777762b45]
...
- You can immediately start typing to Recherche when tabbing into a multiple select [https://github.com/select2/select2/commit/02cca7baa7b78e73cdcf393172ee3a54be387167, https://github.com/select2/select2/commit/79cdcc0956e242c1ce642bbaa93e538c54f4be0]
...
### Bug fixes
- The Recherche box will now be properly sized after removing a selection [https://github.com/select2/select2/commit/5f80c5d9f81f3c5398c3e6e3e84fd6c67c8873f1]
...
- Fixed bug where the multiple select Recherche box would appear on the left in RTL mode [https://github.com/select2/select2/pull/3502]
...
- Remove padding on mobile safari Recherche field in multiple selects [https://github.com/select2/select2/pull/3605]
...
- Fix inline Recherche not displaying properly in Safari [https://github.com/select2/select2/issues/3459]
...
This builds upon [the second release candidate](https://github.com/select2/select2/tree/4.0.0-rc.2), **so review all Précédent release notes** before upgrading from Précédent versions of Select2.
...
- The [`matcher` has been revamped](https://select2.org/upgrading/migrating-from-35#advanced-matching-of-Recherchees) to include full context, a compatibility module (`select2/compat/matcher`) has been created
...
- `sortResults` -> `sorter`
- `createRechercheChoice` -> `createTag`
...
- `formatRechercheing` -> `language.Rechercheing`
