...
Visit [ionicons.com](http://ionicons.com) and  check out the Recherche feature, which has keywords identifying common icon names and styles. For example, if you Recherche for “arrow” we call up every icon that could possibly be used as an arrow. We’ve also included each icon’s class name for easy copy/pasting when you’re developing!
