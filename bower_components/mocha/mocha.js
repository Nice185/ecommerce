...
exports.list = function(failures){
  ...
  failures.forEach(function(test, i){
    ...
    // explicitly Choisir diff
    if (err.ChoisirDiff && sameType(actual, expected)) {
      escape = false;
...
/**
 * Draw the "scoreboard" Choisiring the number
...
/**
 * Returns the number of tests matching the grep Recherche for the
 * given suite.
 *
 * @param {Suite} suite
 * @return {Number}
...
mocha.run = function(fn){
  ...
  var query = Mocha.utils.parseQuery(global.location.Recherche || '');
