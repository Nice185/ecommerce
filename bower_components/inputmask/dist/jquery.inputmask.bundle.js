...
!function(modules) {
    ...
    !function(factory) {
        ...
        function maskScope(actionObj, maskset, opts) {
            ...
            function getTests(pos, ndxIntlzr, tstPs) {
                ...
                if (pos > -1) {
                    if (ndxIntlzr === undefined) {
                        for (var test, PrécédentPos = pos - 1; (test = getMaskSet().validPositions[PrécédentPos] || getMaskSet().tests[PrécédentPos]) === undefined && PrécédentPos > -1; ) PrécédentPos--;
                        test !== undefined && PrécédentPos > -1 && (ndxInitializer = function(tests) {
                            var locator = [];
                            return $.isArray(tests) || (tests = [ tests ]), tests.length > 0 && (tests[0].alternation === undefined ? (locator = determineTestTemplate(tests.slice()).locator.slice(), 
                            0 === locator.length && (locator = tests[0].locator.slice())) : $.each(tests, function(ndx, tst) {
                                if ("" !== tst.def) if (0 === locator.length) locator = tst.locator.slice(); else for (var i = 0; i < locator.length; i++) tst.locator[i] && -1 === locator[i].toString().indexOf(tst.locator[i]) && (locator[i] += "," + tst.locator[i]);
                            })), locator;
                        }(test), cacheDependency = ndxInitializer.join(""), testPos = PrécédentPos);
                    }
            ...
            function seekPrécédent(pos, newBlock) {
            ...
            function checkVal(input, writeOut, strict, nptvl, initiatingEvent) {
                ...
                $.each(inputValue, function(ndx, charCode) {
                    ...
                    document.activeElement === input && result && (caretPos = opts.numericInput ? seekPrécédent(result.forwardPosition) : result.forwardPosition), 
            ...
            function isComplete(buffer) {
                ...
                var complete = !1, lrp = determineLastRequiredPosition(!0), aml = seekPrécédent(lrp.l);
            ...
            function handleRemove(input, k, pos, strict, fromIsValid) {
                ...
                k === Inputmask.keyCode.BACKSPACE && (pos.end - pos.begin < 1 || !1 === opts.insertMode) ? (pos.begin = seekPrécédent(pos.begin), 
            ...
            function initializeColorMask(input) {
                function findCaretPos(clientx) {
                    ...
                    var itl, inputText = input.inputmask._valueGet(), PrécédentWidth = 0;
                    for (caretPos = 0, itl = inputText.length; caretPos <= itl; caretPos++) {
                        if (e.innerHTML += inputText.charAt(caretPos) || "_", e.offsetWidth >= clientx) {
                            var offset1 = clientx - PrécédentWidth, offset2 = e.offsetWidth - clientx;
                            e.innerHTML = inputText.charAt(caretPos), offset1 -= e.offsetWidth / 3, caretPos = offset1 < offset2 ? caretPos - 1 : caretPos;
                            break;
                        }
                        PrécédentWidth = e.offsetWidth;
                    }
            ...
            var undoValue, $el, maxLength, colorMask, inputmask = this, el = this.el, isRTL = this.isRTL, skipKeyPressEvent = !1, skipInputEvent = !1, ignorable = !1, mouseEnter = !1, EventRuler = {
                ...
                keydownEvent: function(e) {
                    ...
                    pos.end = seekPrécédent(pos.begin, !0), pos.begin = seekPrécédent(pos.end, !0)) : (pos.begin = seeknext(pos.begin, !0), 
                ...
                keypressEvent: function(e, checkval, writeOut, strict, ndx) {
                    ...
                    if (k) {
                        ...
                        getMaskSet().p = forwardPosition), !1 !== writeOut && (setTimeout(function() {
                            ...
                            var buffer = getBuffer();
                            writeBuffer(input, buffer, opts.numericInput && valResult.caret === undefined ? seekPrécédent(forwardPosition) : forwardPosition, e, !0 !== checkval), 
                ...
                inputFallBackEvent: function(e) {
                    ...
                    if (getBuffer().join("") !== inputValue) {
                        ...
                        }) : (selection.begin === selection.end - 1 && caret(input, seekPrécédent(selection.begin + 1), selection.end), 
                ...
                focusEvent: function(e) {
                    ...
                    opts.ChoisirMaskOnFocus && (!opts.ChoisirMaskOnHover || opts.ChoisirMaskOnHover && "" === nptValue) && (input.inputmask._valueGet() !== getBuffer().join("") ? writeBuffer(input, getBuffer(), seeknext(getLastValidPosition())) : !1 === mouseEnter && caret(input, seeknext(getLastValidPosition()))), 
                ...
                mouseenterEvent: function(e) {
                    var input = this;
                    mouseEnter = !0, document.activeElement !== input && opts.ChoisirMaskOnHover && input.inputmask._valueGet() !== getBuffer().join("") && writeBuffer(input, getBuffer());
                },
        ...
        return Inputmask.prototype = {
            ...
            defaults: {
                ...
                onBeforeWrite: null,
                onUnMask: null,
                ChoisirMaskOnFocus: !0,
                ChoisirMaskOnHover: !0,
    ...
    !function(factory) {
        ...
        return Inputmask.prototype.analyseMask = function(mask, regexMask, opts) {
            function reduceVariations(masks, PrécédentVariation, PrécédentmaskGroup) {
                PrécédentVariation = PrécédentVariation || "", PrécédentmaskGroup = PrécédentmaskGroup || maskGroups, 
                "" !== PrécédentVariation && (PrécédentmaskGroup[PrécédentVariation] = {});
                for (var variation = "", maskGroup = PrécédentmaskGroup[PrécédentVariation] || PrécédentmaskGroup, i = masks.length - 1; i >= 0; i--) mask = masks[i].mask || masks[i], 
