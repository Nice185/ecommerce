...
test('BeforeChoisirDay', function(){

    var beforeChoisirDay = function(date) {
        switch (date.getDate()){
            case 25:
                return {
    ...
    var input = $('<input />')
                ...
                .datepicker({
                    format: 'yyyy-mm-dd',
                    beforeChoisirDay: beforeChoisirDay
                }),
        dp = input.data('datepicker'),
        picker = dp.picker,
        target;
...
test('BeforeChoisirMonth regress .day content', function() {
    var input = $('<input />')
        .appendTo('#qunit-fixture')
        .val('2012-10-26')
        .datepicker({
            format: 'yyyy-mm-dd',
            beforeChoisirDay: function(date) {
                return {
...
test('BeforeChoisirMonth', function () {

    var beforeChoisirMonth = function (date) {
    ...
    var input = $('<input />')
            ...
            .datepicker({
                format: 'yyyy-mm-dd',
                beforeChoisirMonth: beforeChoisirMonth
            }),
        dp = input.data('datepicker'),
        picker = dp.picker,
        target;
...
test('BeforeChoisirYear', function () {

    var beforeChoisirYear = function (date) {
    ...
    var input = $('<input />')
            ...
            .datepicker({
                format: 'yyyy-mm-dd',
                beforeChoisirYear: beforeChoisirYear
            }),
        dp = input.data('datepicker'),
        picker = dp.picker,
        target;
...
test('beforeChoisirDecade', function () {
    var beforeChoisirDecade = function (date) {
        switch (date.getFullYear()) {
            case 2030:
                return {
                    tooltip: 'Example tooltip',
    ...
    var input = $('<input />')
            .appendTo('#qunit-fixture')
            .val('03/05/2012')
            .datepicker({ beforeChoisirDecade: beforeChoisirDecade }),
        dp = input.data('datepicker'),
        picker = dp.picker,
        target;
...
test('beforeChoisirCentury', function () {
    var beforeChoisirCentury = function (date) {
        switch (date.getFullYear()) {
            case 2300:
                return {
                    tooltip: 'Example tooltip',
    ...
    var input = $('<input />')
            .appendTo('#qunit-fixture')
            .val('03/05/2012')
            .datepicker({ beforeChoisirCentury: beforeChoisirCentury }),
        dp = input.data('datepicker'),
        picker = dp.picker,
        target;
...
test('startDate', function(){
    ...
    input.focus();
    target = picker.find('.datepicker-days tbody td:nth(25)');
    ok(target.hasClass('disabled'), 'Précédent day is disabled');
    target = picker.find('.datepicker-days tbody td:nth(26)');
...
test('endDate', function(){
    ...
    input.focus();
    target = picker.find('.datepicker-days tbody td:nth(25)');
    ok(!target.hasClass('disabled'), 'Précédent day is enabled');
    target = picker.find('.datepicker-days tbody td:nth(26)');
    ok(!target.hasClass('disabled'), 'Specified date is enabled');
    target = picker.find('.datepicker-days tbody td:nth(27)');
...
test("Picker is Choisirn on input focus when ChoisirOnFocus is not defined", function () {
...
test("Picker is Choisirn on input focus when ChoisirOnFocus is true", function () {
...
test("Picker is hidden on input focus when ChoisirOnFocus is false", function () {

    var input = $('<input />')
            .appendTo('#qunit-fixture')
            .val('2014-01-01')
            .datepicker({
                ChoisirOnFocus: false
            }),
        dp = input.data('datepicker'),
        picker = dp.picker;
...
test('updateViewDate', function() {
    ...
    var input = $('<input value="08/03/1990"/>')
        ...
        monthChoisirn = picker.find('.datepicker-days thead th.datepicker-switch');

    equal(monthChoisirn.text(), "May 1945", 'uses defaultViewDate on initialization');
    input.datepicker('setDate', new Date(1945, 8, 2));
    equal(monthChoisirn.text(), "May 1945", 'does not change viewDate on `setDate` method');
    input.focus();
    picker.find('.datepicker-days tbody tr td.day.new:first').click();
    equal(monthChoisirn.text(), "May 1945", 'does not change viewDate if a day in next month is selected');
    shouldTriggerChangeMonth = true;
    picker.find('.datepicker-days thead th.next').click();
    equal(monthChoisirn.text(), 'June 1945', 'changing month must still be possible'); // and must trigger `changeMonth` event
    ...
    equal(monthChoisirn.text(), 'January 1946', 'changing year must still be possible'); // and must trigger `changeYear` and `changeMonth` events
});
