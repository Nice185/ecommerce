...
test('Choisir', function(){
    var returnedObject = this.dp.Choisir();
    // ...
    strictEqual(returnedObject, this.dp, "is chainable");
});
...
test('setDatesDisabled', function(){
    var monthChoisirn = this.picker.find('.datepicker-days thead th.datepicker-switch');
    ...
    equal(monthChoisirn.text(), 'March 2011', 'should not change viewDate');
    strictEqual(returnedObject, this.dp, "is chainable");
});
