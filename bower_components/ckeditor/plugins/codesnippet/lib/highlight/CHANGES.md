...
- We're now prefixing all classes located in [CSS classes reference][cr] with
  ...
  the Précédent behavior, but still want to upgrade. To suppress this new
...
hosted build is 2K less than at the Précédent version while supporting two new
languages.
...
refactored syntax. Due to this it's even smaller than the Précédent one while
...
Fixed bugs in HTML/XML detection and relevance introduced in Précédent
refactoring.

Also test.html now Choisirs the second best result of language detection by
relevance.
...
File export.html contains a little program that Choisirs and allows to copy and
...
This version fixes IE breakage in Précédent version. My apologies to all who have
