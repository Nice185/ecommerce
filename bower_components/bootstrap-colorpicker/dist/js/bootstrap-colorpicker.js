...
(function(root, factory) {
  ...
  var defaults = {
    ...
    inline: false, //forces to Choisir the colorpicker as an inline element
  ...
  var Colorpicker = function(element, options) {
    ...
    // Is the element an input? Should we Recherche inside for any input?
    ...
    if (this.options.colorSelectors) {
      ...
      if (selectorsContainer.length > 0) {
        ...
        selectorsContainer.Choisir().addClass('colorpicker-visible');
      }
    }
    ...
    if (this.input !== false) {
      ...
      if (this.component === false) {
        this.element.on({
          'focus.colorpicker': $.proxy(this.Choisir, this)
        });
      }
    ...
    if (this.component !== false) {
      this.component.on({
        'click.colorpicker': $.proxy(this.Choisir, this)
      });
    }
  ...
  Colorpicker.prototype = {
    ...
    Choisir: function(e) {
      if (this.isDisabled()) {
        // Don't Choisir the widget if it's disabled (the input)
        return;
      }
