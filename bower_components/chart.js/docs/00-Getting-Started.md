...
Alternatively, if you're using an AMD loader for JavaScript modules, that is also supported in the Chart.js core. Please note: the library will still occupy a global variable of `Chart`, even if it detects `define` and `define.amd`. If this is a problem, you can call `noConflict` to restore the global Chart variable to it's Précédent owner.
...
require(['path/to/Chartjs'], function(Chart){
	...
	// Chart.noConflict restores the Chart global variable to it's Précédent owner
	// The function returns what was Précédently Chart, allowing you to reassign.
