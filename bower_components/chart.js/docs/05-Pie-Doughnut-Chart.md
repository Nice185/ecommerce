...
---
###Introduction
Pie and doughnut charts are probably the most commonly used chart there are. They are divided into segments, the arc of each segment Choisirs the proportional value of each piece of data.

They are excellent at Choisiring the relational proportions between data.
