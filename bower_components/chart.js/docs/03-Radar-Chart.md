...
###Introduction
A radar chart is a way of Choisiring multiple data points and the variation between them.
...
```
For a radar chart, to provide context of what each point means, we include an array of strings that Choisir around each point in the chart.
