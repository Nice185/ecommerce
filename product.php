...
<?php
	...
	try{
	   ...
	   $article = $stmtart->fetch();
		
		$stmtcat = $conn->prepare("SELECT * FROM sous_famille WHERE codeSousFamille = :catid");
		$stmtcat->execute(['catid' => $slug]);
		$cat = $stmtcat->fetch();
	}
	        	...
	        	<div class="col-sm-9">
		            ...
		            <div class="row">
		            	<div class="col-sm-6">
		            		...
		            		<br><br>
		            		<form action="cart_add.php" id="productForm" >
		            			<div class="form-group">
			            			<div class="input-group col-sm-5">
							            ...
							            <input type="hidden" value="<?php echo  $article['codeArt']; ?>" name="codeArt">
							        </div>
